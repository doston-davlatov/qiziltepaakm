...
<footer class="bg-gray-800 text-white">
        ...
        <!-- Copyright -->
        <div class="bg-gray-900 py-4 relative z-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-4 mt-2 md:mt-0">
                        <a href="privacy-policy.php" class="text-gray-400 hover:text-white text-sm transition duration-300">Maxfiylik siyosati</a>
                        <a href="terms-of-use.php" class="text-gray-400 hover:text-white text-sm transition duration-300">Foydalanish shartlari</a>
                        <a href="sitemap.php" class="text-gray-400 hover:text-white text-sm transition duration-300">Sayt xaritasi</a>
                    </div>
                    <div class="mt-4 md:mt-0 bg-white p-2 rounded-md shadow-lg">
                        <a href="https://www.uz/ru/res/visitor/index?id=YOUR_ID" target="_blank" class="flex items-center">
                            <img src="https://cnt0.www.uz/counter/collect?id=YOUR_ID&t=visitor" alt="Statistika" class="h-8">
                            <span class="ml-2 text-sm text-gray-700">Sayt statistikasi</span>
                        </a>
                    </div>
                </div>
            </div>
